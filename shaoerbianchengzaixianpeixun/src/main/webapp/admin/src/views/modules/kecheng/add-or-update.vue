        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="年龄段" prop="nianlingduanTypes">
                        <el-select v-model="ruleForm.nianlingduanTypes" :disabled="ro.nianlingduanTypes" placeholder="请选择年龄段">
                            <el-option
                                v-for="(item,index) in nianlingduanTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="年龄段" prop="nianlingduanValue">
                        <el-input v-model="ruleForm.nianlingduanValue"
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名费用" prop="kechengNumber">
                       <el-input v-model="ruleForm.kechengNumber"
                                 placeholder="报名费用" clearable  :readonly="ro.kechengNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="报名费用" prop="kechengNumber">
                           <el-input v-model="ruleForm.kechengNumber"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=nianlingduan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.nianlingduanTypesOptions = data.data.list;
                    }
                });
